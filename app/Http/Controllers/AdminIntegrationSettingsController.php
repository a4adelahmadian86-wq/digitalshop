...
{
    public function edit(){abort_unless(auth()->user()?->hasPermission('integrations.manage'),403);return view('admin.settings.integrations',['mail'=>['enabled'=>filter_var(SiteSetting::getValue('mail.enabled',false),FILTER_VALIDATE_BOOLEAN),'host'=>SiteSetting::getValue('mail.host',''),'port'=>SiteSetting::getValue('mail.port',587),'username'=>SiteSetting::getValue('mail.username',''),'encryption'=>SiteSetting::getValue('mail.encryption','tls'),'from_address'=>SiteSetting::getValue('mail.from_address',''),'from_name'=>SiteSetting::getValue('mail.from_name','فایل‌مارکت')],'google'=>['enabled'=>filter_var(SiteSetting::getValue('google.enabled',false),FILTER_VALIDATE_BOOLEAN),'client_id'=>SiteSetting::getValue('google.client_id',''),'client_secret'=>SiteSetting::getValue('google.client_secret','')]]);}
