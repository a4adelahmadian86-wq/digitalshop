...
{
    protected $fillable = [
        'category_id', 'storage_provider_id', 'title', 'slug',
        'short_description', 'description', 'price', 'file_name',
        'file_path', 'storage_path', 'thumbnail', 'is_published',
        'ai_status', 'ai_score', 'ai_summary', 'ai_report',
        'ai_source_hash', 'ai_indexed_at',
    ];
