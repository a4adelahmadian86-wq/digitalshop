...
{
    protected $fillable = [
        'category_id','storage_provider_id','title','slug','short_description','description','seo_keywords','meta_title','meta_description',
        'file_format','page_count','price','file_name','file_path','storage_path','thumbnail','is_published','ai_status','ai_score','ai_summary',
        'ai_report','ai_source_hash','ai_indexed_at','approval_status','submitted_by','submitted_at','approved_by','approved_at','approval_note'
    ];
