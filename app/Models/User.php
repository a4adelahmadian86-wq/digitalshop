...
class User extends Authenticatable
{
    ...
    protected $fillable=['phone','first_name','last_name','national_code','phone_verified_at','national_code_verified_at','password','role','is_active'];
    ...
    public function aiMemories():HasManyRelation{return$this->hasMany(UserAiMemory::class);}
}
