...
@section('content')
<div class="admin-page narrow"><div class="admin-page-head"><div><div class="admin-eyebrow">مدیریت دسته‌بندی‌ها</div><h1>افزودن دسته‌بندی</h1><p>دسته اصلی یا زیرگروه جدید ایجاد کنید.</p></div></div>
...
<div class="form-group"><label>نامک انگلیسی</label><input type="text" name="slug" value="{{ old('slug') }}" placeholder="programming" dir="ltr" required><small>فقط حروف انگلیسی، اعداد، خط تیره و زیرخط.</small></div>
