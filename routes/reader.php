...
Route::get('/email/start',[EmailOnboardingController::class,'create'])->name('email.onboarding');Route::post('/email/start',[EmailOnboardingController::class,'send'])->name('email.onboarding.send');Route::get('/email/verify/{token}',[EmailOnboardingController::class,'verify'])->name('email.onboarding.verify');Route::get('/email/phone',[EmailOnboardingController::class,'phone'])->name('email.onboarding.phone');Route::post('/email/phone',[EmailPhoneController::class,'send'])->name('email.onboarding.phone.send');Route::post('/email/phone/verify',[EmailPhoneController::class,'verify'])->name('email.onboarding.phone.verify');
...
Route::get('/integrations',[AdminIntegrationSettingsController::class,'edit'])->name('admin.integrations.settings');Route::put('/integrations',[AdminIntegrationSettingsController::class,'update'])->name('admin.integrations.update');Route::post('/integrations/test-mail',[AdminIntegrationSettingsController::class,'testMail'])->name('admin.integrations.test-mail');
