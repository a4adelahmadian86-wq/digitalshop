...
use App\Http\Controllers\AdminAiFeedbackController;
...
Route::post('/ai/products/{product}/evidence', [AiKnowledgeController::class, 'evidence'])->name('ai.product.evidence');
...
Route::prefix('admin')->middleware(['auth', 'role:admin'])->group(function () {
    ...
    Route::get('/ai', [AdminAiDashboardController::class, 'index'])->name('admin.ai.dashboard');
    Route::get('/ai/feedback', [AdminAiFeedbackController::class, 'index'])->name('admin.ai.feedback');
    Route::get('/ai/knowledge', [AdminAiKnowledgeController::class, 'index'])->name('admin.ai.knowledge');
    Route::post('/ai/knowledge/{product}', [AdminAiKnowledgeController::class, 'indexProduct'])->name('admin.ai.knowledge.index-product');
